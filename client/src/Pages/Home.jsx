            ...
            <div className="min-h-screen flex flex-col lg:flex-row items-center justify-center bg-cover bg-center mt-5" style={{ backgroundImage: `url(${ConnectImg})` }}>
                <div className="bg-black bg-opacity-50 lg:w-1/2 max-w-xl mx-auto px-4 py-8 text-center rounded-lg">
                    ...
                    <div className="max-w-md mx-auto text-left text-white space-y-4">
                        <p>Input a GitHub username or profile link to connect with others. Instantly view comprehensive GitHub profiles, including activities and repositories.</p>
                        <p>Export the gathered information in CSV format for detailed analysis. Ideal for recruiters, developers, and project managers to assess skills, discover projects, and monitor contributions.</p>
                    </div>
                    <Link to="/get-connect">
